...
// $Rev: 52393 $
// File generated on 18-01-2015 22:22:05 from Type Library described below.
...
(*{The DispID for this method is DISPID_UNKNOWN!?. }
    -1: if Assigned(FOnResponseDataAvailable) then
         FOnResponseDataAvailable(Self, {NOT_OLEAUTO(PSafeArray)}OleVariant((TVarData(Params[0]).VPointer)^) {var  NOT_OLEAUTO(PSafeArray) OleVariant});
*)
(*{The DispID for this method is DISPID_UNKNOWN!?. }
...
begin
  Result := DefaultInterface.Option[Option];
end;
